    ...
    plugins: [
        laravel({
            input: [
                ...
                "resources/js/assets/plugins/jquery-mousewheel/jquery.mousewheel.j",
                "resources/js/assets/plugins/raphael/raphael.min.j",
                "resources/js/assets/plugins/jquery-mapael/jquery.mapael.min.j",
                "resources/js/assets/plugins/jquery-mapael/maps/usa_states.min.j",
                "resources/js/assets/plugins/chart.js/Chart.min.j",
            ],
            refresh: true,
        }),
        vue(),
