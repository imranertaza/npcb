...
@section('breadcrumb', 'News and Updates')
@section('content')
                        ...
                        <div class="latest-blog-card news-card card-smooth">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="title-four mb-12">
                                    <a href="" class="">Amputee Football Festival showcases rising talent in
                                        Dhaka</a>
                                </h5>
                                <p class="content-text mb-3">Amputee Football Festival showcases rising talent in
                                    Dhaka....
                                </p>
                                <a href="{{ route('news-and-updates-details', $item->slug) }}" class="btn-primary btn-common">View Details</a>
                            </div>
                        </div>
                    </div>
                @empty
