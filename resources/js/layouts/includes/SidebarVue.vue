        ...
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
          ...
          >
            ...
            <ul class="nav nav-treeview" v-show="isOpen('posts')">
              ...
              <li
                class="nav-item"
                :class="{ 'menu-open': isOpen('categories') }"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-news')"
          ...
          >
            ...
            <ul class="nav nav-treeview" v-show="isOpen('news')">
              ...
              <li
                class="nav-item"
                v-if="authStore.hasPermission('view-news-categories')"
              ...
              >
                ...
                <ul class="nav nav-treeview" v-show="isOpen('newsCategories')">
                  ...
                  <li
                    class="nav-item"
                    v-if="authStore.hasPermission('create-news-categories')"
                  >
                    <router-link
                      :to="{ name: 'NewsCategoryCreate' }"
                      class="nav-link"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-blog')"
          ...
          >
            ...
            <ul class="nav nav-treeview" v-show="isOpen('blog')">
              ...
              <li
                class="nav-item"
                v-if="authStore.hasPermission('view-blog-categories')"
              ...
              >
                ...
                <ul class="nav nav-treeview" v-show="isOpen('blogCategories')">
                  ...
                  <li
                    class="nav-item"
                    v-if="authStore.hasPermission('create-blog-categories')"
                  >
                    <router-link
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-galleries')"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-events')"
          ...
          >
            ...
            <ul class="nav nav-treeview" v-show="isOpen('events')">
              ...
              <li
                class="nav-item"
                :class="{ 'menu-open': isOpen('event-categories') }"
              ...
              >
                ...
                <ul class="nav nav-treeview" v-show="isOpen('event-categories')">
                  ...
                  <li
                    class="nav-item"
                    v-if="authStore.hasPermission('create-events-categories')"
                  >
                    <router-link
                      :to="{ name: 'EventCategoryCreate' }"
                      class="nav-link"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-notices')"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-players')"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('manage-committee-members')"
          ...
          >
            ...
            <ul class="nav nav-treeview" v-show="isOpen('committee-members')">
              ...
              <li class="nav-item">
                <router-link
                  :to="{ name: 'CreateCommitteeMembers' }"
                  class="nav-link"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('view-results')"
          ...
          <li
            class="nav-item"
            v-if="authStore.hasPermission('manage-frontend')"
