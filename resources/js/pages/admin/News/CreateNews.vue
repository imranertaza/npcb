                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- Image & Alt -->
                                    <div class="form-group">
                                        <label>Upload Banner Image Top News or Video (Max 500MB)</label>
                                        <Vue3Dropzone acceptedFiles="image/*,video/*" :maxFileSize="500"
                                            v-model="imageFile" :allowSelectOnPreview="true" />
...
// Dropzone references
const imageFile = ref(null);     // Main image upload
const f_imageFile = ref(null);   // Featured image upload

// Reactive form state for new news item
const form = reactive({
    news_title: "",
    slug: "",
    short_des: "",
...
/**
 * Fetch all news categories (per_page=0 to get all)
 */
...
/**
 * Submit the news creation form
 * Builds FormData with text fields, images, and categories array
 */
