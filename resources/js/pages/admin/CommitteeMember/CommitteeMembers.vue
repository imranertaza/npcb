            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr v-for="(member, index) in members?.data" :key="member.id">
                  ...
                  <td class="align-middle">
                    <select v-model="member.status" @change="updateStatus(member)" class="custom-select"
                  ...
                  <td class="align-middle">
                    <div class="d-flex">
                      <router-link :to="{ name: 'UpdateCommitteeMembers', params: { id: member.id } }"
                        class="btn btn-sm btn-outline-info">
                        <i class="fas fa-pencil-alt"></i>
                      </router-link>
                      <button class="ml-2 btn btn-sm btn-outline-danger" @click="confirmDelete(member)">
