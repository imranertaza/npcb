<template>
    <DashboardHeader title="Category Details" :back="true" @back="goBack()" />
        ...
        <div class="card">
            <div class="card-body" v-if="category">
                ...
                <router-link v-if="authStore.hasPermission('edit-categories')"
                    :to="{ name: 'UpdateCategory', params: { id: category?.id } }"
                    class="ml-2 btn btn-outline-info mt-3 ms-2">
                    Edit
                </router-link>
            </div>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <button v-if="authStore.hasPermission('view-categories')"
                                                @click="fetchCategory(cat.id)" class="btn btn-sm btn-outline-dark">
