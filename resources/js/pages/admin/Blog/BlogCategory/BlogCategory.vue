                  ...
                  <td class="align-middle">
                    <div class="d-flex">
                      <router-link v-if="authStore.hasPermission('view-blog-categories')"
                        :to="{ name: 'BlogCategoryShow', params: { id: cat.id } }" class="btn btn-sm btn-outline-dark">
                        <i class="fas fa-eye"></i>
                      </router-link>

                      <router-link v-if="authStore.hasPermission('edit-blog-categories')"
                        :to="{ name: 'UpdateBlogCategory', params: { id: cat.id } }" class="ml-2 btn btn-sm btn-outline-info">
                        <i class="fas fa-pencil-alt"></i>
                      </router-link>

                      <button v-if="authStore.hasPermission('delete-blog-categories')" class="ml-2 btn btn-sm btn-outline-danger"
