    ...
    <section class="mt-3">
        <div class="card">
            <div class="card-body" v-if="category">
                ...
                <router-link :to="{ name: 'BlogCategoryIndex' }" class="btn btn-secondary mt-3">Back to
                    List</router-link>
                <router-link v-if="authStore.hasPermission('edit-blog-categories')"
                    :to="{ name: 'UpdateBlogCategory', params: { id: category?.id } }"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr v-for="(cat, index) in category?.children" :key="cat.id">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <button v-if="authStore.hasPermission('view-blog-categories')"
...
// Single blog category data (fetched from API)
...
/**
 * Fetch the blog category details by ID
...
// Optional props (kept for compatibility/flexibility, though ID is primarily from route)
defineProps({
    id: {
        type: [Number, String],
        required: false
